...
import { i18n, normalizePath, } from 'typedoc';
/**
...
export async function render(renderer, project, outputDirectory) {
    ...
    for (const page of pages) {
        await renderDocument(renderer, outputDirectory, page, project, formatWithPrettier);
    }
...
function prepareRouter(renderer) {
    ...
    if (!ctor) {
        renderer.application.logger.error(i18n.router_0_is_not_defined_available_are_1(routerOption, ['member', 'module'].join(', ')));
        return false;
    }
...
async function renderDocument(renderer, outputDirectory, page, project, formatWithPrettier) {
...
export async function formatWithPrettierIfAvailable(renderer, code) {
...
export async function executeJobs(jobs, output) {
